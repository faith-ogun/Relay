...
export const LESSON_CONTENT: Record<string, { steps: AuthoredStep[]; xpReward: number }> = {
  ...
  'From AC to DC': {
    ...
    steps: [
      ...
      { type: 'predict_reading', difficulty: 3, question: 'A full-wave rectifier runs from 50 Hz mains. At what rate does its output ripple, since both half-cycles make a hump?', options: ['100 Hz', '50 Hz', '25 Hz', '0 Hz'], correct: 0, explanation: 'Full-wave gives two humps per input cycle, so the ripple is at twice the line frequency: 100 Hz.' },
    ],
  },
  ...
  'The Linear Regulator': {
    ...
    steps: [
      ...
      { type: 'predict_reading', difficulty: 2, question: 'A 7805 has about 2V of dropout. For a clean 5V out, the input must be at least about...', options: ['7V', '5V', '4V', '5.5V'], correct: 0, explanation: '5V output + ~2V dropout ≈ 7V minimum input.' },
  ...
  'Unit 10 Checkpoint': {
    ...
    steps: [
      ...
      { type: 'predict_reading', question: 'A bridge rectifier uses how many diodes?', options: ['Four', 'One', 'Two', 'Eight'], correct: 0, explanation: 'Four diodes give full-wave rectification.' },
