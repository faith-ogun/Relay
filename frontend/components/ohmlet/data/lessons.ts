...
export const LESSON_CONTENT: Record<string, { steps: AuthoredStep[]; xpReward: number }> = {
  ...
  'The Golden Rules': {
    ...
    steps: [
      ...
      { type: 'predict_reading', difficulty: 2, question: 'A non-inverting amp has +2V on its + input and negative feedback. What is the − input voltage?', options: ['About 2V (the inputs match)', 'About 0V at all times', 'About the supply voltage', 'Roughly half of 2V, so 1V'], correct: 0, explanation: 'By rule 1, the output adjusts until the − input also sits at ~2V.' },
  ...
  'Single-Supply Op-Amps': {
    ...
    steps: [
      ...
      { type: 'predict_reading', difficulty: 2, question: 'On a 5V single supply, a sensible mid-rail bias point is...', options: ['About 2.5V', 'About 0V', 'About 5V', 'About 10V'], correct: 0, explanation: 'Half of 5V is 2.5V, giving equal swing room up and down.' },
