...
export const LESSON_CONTENT: Record<string, { steps: AuthoredStep[]; xpReward: number }> = {
  ...
  'Powering Motors Safely': {
    ...
    steps: [
      ...
      { type: 'multiple_choice', difficulty: 1, question: 'A bulk capacitor across the motor supply is there to...', options: ['Smooth out the sudden current surges the motor draws', 'Increase the motor\'s top speed beyond its rating', 'Replace the need for a separate motor supply entirely', 'Convert the motor supply from DC into clean AC'], correct: 0, explanation: 'The bulk cap acts as a local reservoir, supplying surge current so the rail does not dip.' },
  ...
  'Talking to Modules': {
    ...
    steps: [
      ...
      // ── Tier 1: recall ──
      { type: 'multiple_choice', difficulty: 1, question: 'On an I2C bus, a specific device is singled out by its...', options: ['Address', 'Colour', 'Baud rate', 'Step count'], correct: 0, explanation: 'Each I2C device has an address; only the named one responds on the shared wires.' },
  ...
  'The Robot Control Loop': {
    ...
    steps: [
      ...
      { type: 'multiple_choice', difficulty: 1, question: 'In a robot, the ACT stage typically drives...', options: ['Motors, an H-bridge, or a servo', 'Only a single status LED', 'Nothing, it just reads sensors', 'The serial monitor on the PC'], correct: 0, explanation: 'Acting means moving the robot: motors and actuators, not just an indicator.' },
  ...
  'Closing the Loop with Feedback': {
    ...
    steps: [
      ...
      { type: 'multiple_choice', difficulty: 1, question: 'An encoder on a robot wheel measures...', options: ['How far the wheel has actually turned', 'The supply voltage of the battery', 'The colour of the floor below it', 'The distance to the nearest wall'], correct: 0, explanation: 'An encoder counts rotation, giving real wheel movement to feed back.' },
  ...
  'The Line-Follower': {
    ...
    steps: [
      ...
      { type: 'multiple_choice', difficulty: 2, question: 'On a 0 to 1023 analog scale, the line reads ~200 and the floor reads ~800. A sensible threshold is about...', options: ['500, roughly midway between the two', '1000, just below the maximum', '50, just above the minimum', '850, above the floor reading'], correct: 0, explanation: 'A threshold midway between line (200) and floor (800) cleanly separates the two; 500 fits.' },
