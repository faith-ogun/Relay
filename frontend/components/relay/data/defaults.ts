...
import type { AppTab, RelayPersistedState } from '../types';
...
export const DEFAULT_COMMENT_REPLIES: RelayPersistedState['commentReplies'] = {
...
export const DEFAULT_LESSON_PROGRESS: RelayPersistedState['lessonProgress'] = {
  'Voltage Basics': 100,
...
export const DEFAULT_ADAPTIVE_HISTORY: RelayPersistedState['adaptiveHistory'] = [];

export const DEFAULT_POSTS: RelayPersistedState['posts'] = [
  {
    id: 'p1',
...
export const DEFAULT_JOINED_CHALLENGES: RelayPersistedState['joinedChallenges'] = {
  streak7: true,
  genericOnly: false,
  teachBack: false,
};

export const DEFAULT_SKILL_NODES: RelayPersistedState['skillNodes'] = [
...
export const DEFAULT_WEEK_PROGRESS: RelayPersistedState['weekProgress'] = [false, false, false, false, false, false, false];

export const DEFAULT_XP_EVENTS: RelayPersistedState['xpEvents'] = [];
