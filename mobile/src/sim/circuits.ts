...
export const LIVE_CIRCUITS: LiveCircuitDef[] = [
  ...
  },
  {
    ...
    control: { label: 'Lower resistor', unit: 'Ω', min: 500, max: 47000, step: 100, initial: 10000, format: ohms },
    build: (r2) => [
  ...
  },
  {
    ...
    control: { label: 'Second branch', unit: 'Ω', min: 220, max: 10000, step: 10, initial: 2000, format: ohms },
    build: (r2) => [
  ...
  },
  {
    ...
    control: { label: 'Resistor', unit: 'Ω', min: 1000, max: 100000, step: 1000, initial: 10000, format: ohms },
    build: (r) => [
      { kind: 'V', id: 'src', pos: 1, neg: 0, value: 5 },
  ...
  },
  {
    ...
    control: { label: 'Base resistor', unit: 'Ω', min: 1000, max: 470000, step: 1000, initial: 10000, format: ohms },
    build: (rb) => [
