...
const Sparkles: React.FC<P> = ({ size, color = colors.ink }) => (
  <S size={size}>
...
const Camera: React.FC<P> = ({ size, color = colors.ink }) => (
  <S size={size}>
...
const Gamepad2: React.FC<P> = ({ size, color = colors.ink }) => (
  <S size={size}>
...
const BrainCircuit: React.FC<P> = ({ size, color = colors.ink }) => (
  <S size={size}>
...
const Play: React.FC<P> = ({ size, color = colors.ink }) => (
  <S size={size}>
