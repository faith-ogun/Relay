...
export const Transistor: React.FC<{ x: number; y: number; label?: string }> = ({ x, y, label }) => {
  ...
  return (
    <G>
      <Circle cx={x} cy={y} r={20} fill={colors.surface} stroke={colors.ink} strokeWidth={STROKE} />
  ...
  return (
    <G>
      <Path d={`M ${x} ${y - 24} L ${x + 42} ${y} L ${x} ${y + 24} Z`}
            fill={colors.surface} stroke={colors.ink} strokeWidth={STROKE} strokeLinejoin="round" />
...
export const Ldr: React.FC<{ x: number; y: number; label?: string }> = ({ x, y, label }) => {
  ...
  return (
    <G>
      <Rect x={x} y={y - 9} width={40} height={18} rx={3} fill={colors.surface} stroke={colors.ink} strokeWidth={STROKE} />
...
export const Buzzer: React.FC<{ x: number; y: number; label?: string }> = ({ x, y, label }) => {
  ...
  return (
    <G>
      <Circle cx={x} cy={y} r={14} fill={colors.surface} stroke={colors.ink} strokeWidth={STROKE} />
