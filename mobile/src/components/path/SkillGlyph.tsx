...
const Trophy: React.FC<P> = ({ size, color: colorProp }) => {
...
const Gauge: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Cpu: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Wrench: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Lightbulb: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Binary: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Clock: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Microchip: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Cog: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Radar: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
...
const Bot: React.FC<P> = ({ size, color: colorProp }) => {
  const colors = useColors();
  const color = colorProp ?? colors.ink;
  return (
    <S size={size}>
